...
* create time: 7:53:10 PM
* author: hnivq
*/
public class CeramicManage {
	// DanhSachQuanLy ceramicList;

	public static Ceramic inputCeramic()
	{
		...
		Serial serial = new Serial("CM", Ceramic.getCountCM());
		ceramic = new Ceramic(serial, name, importPrice, inventory, importDate);	
		return ceramic;
	}

	public CeramicManage()
	{
		// ceramicList = new DanhSachQuanLy();
	}
